...
from .FPSR_EASEr_model import FPSR_EASEr_model
from elliot.utils import logging as logging_project

logger = logging_project.get_logger("__main__")

class FPSR_EASEr(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            # for EASEr
            ("_neighborhood", "neighborhood", "nn", -1, int, None),
