...
from .FPSR_GFCF_model import FPSR_GFCF_model
from elliot.utils import logging as logging_project

logger = logging_project.get_logger("__main__")

class FPSR_GFCF(RecMixin, BaseRecommenderModel):
    ...
    def get_recommendations(self, k: int = 100):
        ...
        with torch.no_grad():
            for index, offset in enumerate(tqdm(range(0, self._num_users, self._batch_size))):
