...
from .FPSR_RP3beta_model import FPSR_RP3beta_model
from elliot.utils import logging as logging_project

logger = logging_project.get_logger("__main__")

class FPSR_RP3beta(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            # for RP3beta
            ("_neighborhood", "neighborhood", "nn", 10, int, None),
            ("_alpha", "alpha", "alpha", 1., float, None),
            ("_beta", "beta", "beta", 0.6, float, None),
            ("_normalize_similarity", "normalize_similarity", "norm_sim", False, bool, None)
        ]
        self.autoset_params()
        ...
        self._model = FPSR_RP3beta_model(
            ...
            alpha=self._alpha,
            beta=self._beta,
            normalize_similarity=self._normalize_similarity
        )
