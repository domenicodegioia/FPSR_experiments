...
class FPSR_SVDAE_model:
    def __init__(self,
        ...
        adj_mat = self._data.sp_i_train.tolil()
        ...
        del ut, s, vt
        self.W_sparse = batch_dense_matmul_sparse_input(A=A.T, B=adj_mat, device=self.device,
                                                     batch_size=1000)  # A.T @ adj_mat.to_dense()
        del A, adj_mat
